...
%%
    ...
    if ismember(i, [50, 100, 150, 200])
        ...
        % Calculate relative error: (|true - recon| / max(true)) * 100
...
print(figure(2), fullfile(outputDir, 'Figure 14a SnapshotCountorsGaussian.png'), '-dpng', '-r400');
print(figure(3), fullfile(outputDir, 'Figure 14C SnapshotCountorsTrue.png'), '-dpng', '-r400');


filenameFigure4 = 'Figure 14d SnapshotCountorsGaussianRelative.png';
